    ...
    <div className="mx-auto flex max-w-[1500px] flex-col gap-6">
      <section className="relative overflow-hidden rounded-2xl border bg-card p-5 shadow-sm md:p-7">
        ...
        <div className="relative flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div><h1 className="text-2xl font-semibold tracking-tight md:text-3xl">Welcome back, {user.data?.fullName?.split(" ")[0] ?? "there"}</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">{space === "admin" ? "" : space === "examiner" ? "Build assessments, understand candidate performance, and respond to integrity signals." : "Review your schedule, continue active sessions, and prepare for your next secure assessment."}</p></div>
